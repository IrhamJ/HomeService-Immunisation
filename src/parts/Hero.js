      ...
      <Fade bottom>
        <div className="w-full lg:w-1/2 xl:pl-12 sm:pr-2 mt-8">
          ...
          <p className="font-light text-xl text-gray-400 leading-relaxed mb-16">
            Vaksinasi diberikan 100% oleh Dokter spesialis Vaksinasi.
            Lebih aman, nyaman, dan dengan harga yang lebih terjangkau
          </p>

          <Button href="/project" type="link" className="flex w-71 h-18 items-center px-8 py-2 text-white text-xl bg-theme-purple rounded-lg shadow-2xl hover:bg-dark-theme-purple transition duration-200">
            Konsultasi Dokter
