  ...
  return (
    <div className="bg-gray-50 py-20 mb-24 sm:mb-18 xl:mb-16">
      <div className="container mx-auto">
        <Fade bottom>
          <h1 className="text-5xl text-theme-blue text-center font-bold">Jangkauan Area</h1>

          <p className="font-light text-lg text-gray-400 text-center mb-12 sm:mb-5 xl:mb-0">
          Melayani di Wilayah Cianjur Khususnya.
          </p>
        </Fade>
          ...
          <div className="flex-col">
            {
                        data[0].map((item, index) => (
                          <Fade bottom delay={500 * index}>
                            <div>
                              <div className="bg-white flex flex-row p-3 my-6 mx-3 sm:my-7 sm:mx-3 xl:my-14 xl:mx-7 rounded-2xl shadow-xl border border-light-theme-purple transform transition duration-500 hover:scale-105">
